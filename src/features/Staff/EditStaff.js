...
import { useGetStaffsQuery, useDeleteStaffMutation, useUpdateStaffMutation } from '../../store/apis/staffsApiSlice'
...
const EditStaff = () => {
    ...
    const onSave = async(data) =>{
        ...
        try {
            ...
            const res = await updateStaff({ id: staff?.id, staffid: data?.staffid, name, gender: data?.gender, contact })
